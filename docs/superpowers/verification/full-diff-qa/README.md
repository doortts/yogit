...
2026-07-27에 기존 승인 이미지와 macOS 앱을 기준으로 확인했고,
2026-07-28에는 Full Diff 상호작용과 설정 복원을 기능 캡처 24~29로
추가 검수했다. File 화면이 제거되어 예전 03 File 구현·차이 이미지는
폐기했다. 현재 비교 대상인 00~02·04~17은 모두 새로 캡처하고 차이
이미지와 수치도 다시 계산했다. 00–04·06–12 기준 이미지는 이름만
`.png`이고 실제 내용은 JPEG라서 차이 도구는 파일 시그니처로 형식을
판별한다. 05·13–17 기준 이미지는 검토를 통과한 Flutter PNG 캡처다.
JPEG 압축과 Flutter 글꼴 래스터라이징에서 생기는 픽셀 차이는 아래
수치에 포함했다.
...
04·05·07·08은 Split 상태로 캡처했다. 검수 하네스는 Flutter SDK의
Material Icons와 Roboto, macOS의 Menlo와 Apple SD Gothic Neo를
불러오며 Menlo에 없는 글자는 앱에 포함된 D2Coding으로 표시한다.
Blame은 Hunk 머리글 없이 전체 소스와 줄별 메타데이터를 나란히
표시한다. 미니맵은 선택한 이전·결과 쪽 소스 범위로 뷰포트를 계산하며
아래 수치는 이 계산을 적용한 현재 캡처 기준이다.
...
| --- | ---: | ---: | ---: | ---: | ---: |
| 00-overview-hunk | 782×842 | 355,453 | 53.9838 | 16.4453 | 255 |
| 01-diff-inline | 782×842 | 388,730 | 59.0377 | 18.3359 | 255 |
| 02-diff-split | 1070×842 | 517,018 | 57.3865 | 18.1491 | 255 |
| 04-blame-view | 1070×842 | 391,633 | 43.4694 | 17.4201 | 255 |
| 05-history-view | 1070×842 | 289,875 | 32.1747 | 14.7226 | 242 |
| 06-focus-mode | 1070×842 | 389,793 | 43.2651 | 11.4776 | 255 |
| 07-ignore-whitespace | 1070×842 | 505,084 | 56.0619 | 17.7895 | 255 |
| 08-wrap-lines | 1070×842 | 560,031 | 62.1607 | 19.6455 | 255 |
| 09-next-change | 1280×720 | 380,957 | 41.3365 | 9.1269 | 240 |
| 10-algorithm-histogram | 1280×720 | 381,118 | 41.3539 | 9.2880 | 244 |
| 11-responsive-650 | 650×549 | 193,321 | 54.1743 | 19.9698 | 255 |
| 12-responsive-480 | 480×549 | 144,182 | 54.7139 | 19.9654 | 255 |
| 13-font-and-back | 1070×842 | 353,416 | 39.2275 | 13.4546 | 242 |
| 14-algorithm-tooltip | 1070×842 | 448,203 | 49.7484 | 19.2740 | 255 |
| 15-unavailable-panel | 1070×842 | 149,524 | 16.5964 | 7.0238 | 242 |
| 16-history-detail | 1070×842 | 229,485 | 25.4717 | 9.3405 | 242 |
| 17-history-detail-split | 1070×842 | 196,685 | 21.8311 | 8.8998 | 242 |
...
| Diff·Blame·History | 통과 | 세 화면을 차례로 열고 머리글과 콘텐츠가 같은 커밋·파일을 가리키는지 확인 |
| Hunk·Unified·Side-by-side | 통과 | Hunk 범위와 두 레이아웃을 차례로 선택하고 내용과 미니맵을 확인 |
...
24~29는 기준 이미지와 픽셀 차이를 재는 캡처가 아니다. 실제 제품
위젯을 탭·키 입력·드래그한 뒤 상태와 배치를 함께 기록한 기능 검수
이미지다. 자세한 육안 판정과 설계 완료 기준 14개는
[상호작용·저장 검수](interaction-persistence-review.md)에 기록했다.

| 상태 | 캡처 | 크기 | 판정 |
| --- | --- | ---: | --- |
| Unified + Hunk | [24-unified-hunks](actual/24-unified-hunks.png) | 1070×842 | PASS: File 버튼 없음, Hunk 독립 토글, 여러 Hunk의 소스 순서 확인 |
